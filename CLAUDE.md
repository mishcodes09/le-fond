# Current Le Fond direction

The founders' latest brief supersedes earlier positioning and palette rules.

- Primary product: lead generation, funnels and customer follow-up automation for established South African service businesses.
- Core architecture: Capture, Convert, Follow Through. Journey: traffic, landing page, capture, qualification, booking/quote, follow-up, human handoff, reporting.
...
- Preserve Next.js 14, existing dependencies and lockfile. Responsive and reduced-motion behavior must be tested.
